...
start /wait services/dotNetFx40.exe /install /quiet /norestart
...
start /wait services/dxwebsetup.exe /q
...
start /wait services/oalinst.exe /silent
...
start /wait services/xnaf40.msi /passive
...
start /wait services/cpp/vcredist2005_x86.exe /q
...
start /wait services/cpp/vcredist2008_x86.exe /qb
...
start /wait services/cpp/vcredist2010_x86.exe /passive /norestart
...
start /wait services/cpp/vcredist2012_x86.exe /passive /norestart
...
start /wait services/cpp/vcredist2013_x86.exe /passive /norestart
...
start /wait services/cpp/vcredist2015-22_x86.exe /passive /norestart
...
echo    ( %ESC%[36m2005%ESC%[0m %ESC%[34m2008 2010 2012 2013 2015-22%ESC%[0m )
start /wait services/cpp/vcredist2005_x86.exe /q
start /wait services/cpp/vcredist2005_x64.exe /q
...
echo    ( %ESC%[32m2005%ESC%[0m%ESC%[36m 2008%ESC%[0m %ESC%[34m2010 2012 2013 2015-22%ESC%[0m )
start /wait services/cpp/vcredist2008_x86.exe /qb
start /wait services/cpp/vcredist2008_x64.exe /qb
...
echo    ( %ESC%[32m2005 2008%ESC%[0m%ESC%[36m 2010%ESC%[0m %ESC%[34m2012 2013 2015-22%ESC%[0m )
start /wait services/cpp/vcredist2010_x86.exe /passive /norestart
start /wait services/cpp/vcredist2010_x64.exe /passive /norestart
...
echo    ( %ESC%[32m2005 2008 2010%ESC%[0m%ESC%[36m 2012%ESC%[0m %ESC%[34m2013 2015-22%ESC%[0m )
start /wait services/cpp/vcredist2012_x86.exe /passive /norestart
start /wait services/cpp/vcredist2012_x64.exe /passive /norestart
...
echo    ( %ESC%[32m2005 2008 2010 2012%ESC%[0m%ESC%[36m 2013%ESC%[0m %ESC%[34m2015-22%ESC%[0m )
start /wait services/cpp/vcredist2013_x86.exe /passive /norestart
start /wait services/cpp/vcredist2013_x64.exe /passive /norestart
...
echo    ( %ESC%[32m2005 2008 2010 2012 2013%ESC%[0m%ESC%[36m 2015-22%ESC%[0m )
start /wait services/cpp/vcredist2015-22_x86.exe /passive /norestart
start /wait services/cpp/vcredist2015-22_x64.exe /passive /norestart
